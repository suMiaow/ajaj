...
public class Kruskal {
    ...
    public static class Edge implements Comparable<Edge> {
        ...
        public String toString() {
            return vertices.get(start).name + " <-> " + vertices.get(end).name;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        List<Edge> kroskal = kroskal(vertices.size(), queue);
        System.out.println(kroskal);

    }

    public static List<Edge> kroskal(int size, PriorityQueue<Edge> queue) {
